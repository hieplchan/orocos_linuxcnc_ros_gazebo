...
// (in-package joint_angle_msgs.msg)
...
class joint_angle_node {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new joint_angle_node(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new joint_angle_node(null);
...
module.exports = joint_angle_node;
